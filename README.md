...
⭐（目前已更新到v0.2.1版本，BOSS已拥有多阶段和变招能力，请在release版中进行下载。）

创建这个仓库的初衷是为了借此熟悉游戏开发流程，找到游戏开发工作。

还不太会markdown，所以界面有点粗糙......

github仓库中放了release包，里面有我打包好的运行程序，**下载打开就能进行游玩**。目前已达到初步游玩标准，~~先标记为v0.1.1（测试版）~~，先标记为v0.2.1（测试版），后续我会继续更新的。
